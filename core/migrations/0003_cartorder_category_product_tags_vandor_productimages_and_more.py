# Generated by Django 4.1.7 on 2023-09-14 06:28
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product_status', models.CharField(choices=[('procrss', 'Processing'), ('delivered', 'Delivered'), ('shipped', 'Shipped')], default='processing', max_length=30)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product_status', models.CharField(choices=[('published', 'Published'), ('disabled', 'Disabled'), ('draft', 'Draft'), ('in_review', 'In_Review'), ('rejected', 'Rejected')], default='in_review', max_length=10)),
